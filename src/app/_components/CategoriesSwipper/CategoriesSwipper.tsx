            ...
            <div className="container w-[95%] sm:w-[90%] md:w-[85%] lg:w-[80%] mx-auto my-6 dark:text-gray-200">
                ...
                >
                    {categories.map((categ : Category, index) => (
                        <SwiperSlide key={categ._id} className="flex flex-col items-center"> <Image priority={index === 0} src={categ.image} alt="category name" width={500} height={500} className="w-full h-28 sm:h-32 md:h-36 lg:h-40 object-cover" />
